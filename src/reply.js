...
const { prefix, command, visual, all } = require("../config.json")
const { createTimeTracker, getFormattedTimeFromTracker } = require("./time.js")
...
let exampleTimeTrackerA = createTimeTracker()
let exampleTimeTrackerB = createTimeTracker()
...
exampleCommandDurationStr = ([
    "**Examples:**",
    `${prefix}${command} #example-channel @example-user **${getFormattedTimeFromTracker(exampleTimeTrackerA)}**`,
    `${prefix}${command} #example-channel @example-user **${getFormattedTimeFromTracker(exampleTimeTrackerB)}**`,
    `${prefix}${command} #example-channel @example-user **${all.keyword}**`
]).join("\n")